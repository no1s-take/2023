...
import com.example.orders.service.BaseService;
...
public class OrdersController {
    ...
    public String register(@Valid Order order, BindingResult result, Model model,
    ...
    public String update(@PathVariable Integer id, @Valid Order order, BindingResult result,
