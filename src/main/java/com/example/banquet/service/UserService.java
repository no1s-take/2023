...
import com.example.banquet.common.PasswordHasher;
import com.example.banquet.dao.UserDao;
...
public class UserService implements BaseService<User> {
    ...
    private void updateSecurityContext(User user) {
        ...
        context.setAuthentication(new UsernamePasswordAuthenticationToken(userDetails,
